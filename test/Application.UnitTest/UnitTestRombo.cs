...
namespace Application.UnitTest
{
    public class UnitTestRombo
    {
        ...
        public void TestPerimetro(double lado, double perimetro)
        {
            ...
            // Act – Perform
            double resultado = Figura261E12.Perimetro(lado); 
        ...
        public void TestArea(double d, double D, double area)
        {
            // Arrange – Set up

            // Act – Perform
            double resultado = Figura261E12.Area(d, D); 
           
            // Assert – Verify
            Assert.Equal(resultado, area, 1);
        }
        ...
        public void TestVolumen(double area, double altura, double volumen)
        {
            ...
            // Act – Perform
            double resultado = Figura261E12.Volumen(area, altura);
            // Assert – Verify
